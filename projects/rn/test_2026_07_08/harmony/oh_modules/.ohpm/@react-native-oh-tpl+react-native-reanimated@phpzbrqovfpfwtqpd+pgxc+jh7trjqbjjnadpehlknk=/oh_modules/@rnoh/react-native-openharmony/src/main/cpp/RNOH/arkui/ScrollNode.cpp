...
void ScrollNode::setNestedScroll(ArkUI_ScrollNestedMode scrollNestedMode) {
  this->setNestedScroll(scrollNestedMode, scrollNestedMode);
}
...
ScrollNode& ScrollNode::setFlingSpeedLimit(float flingSpeedLimit) {
  if (IsAtLeastApi18()) {
    ArkUI_NumberValue value[] = {{.f32 = flingSpeedLimit}};
    ArkUI_AttributeItem item = {
