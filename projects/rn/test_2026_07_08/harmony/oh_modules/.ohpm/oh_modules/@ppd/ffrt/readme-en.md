...
For the FFRT C++ interface usage guide, please refer to the open-source community documentation ([Function Flow Runtime C++ API](https://gitee.com/openharmony/resourceschedule_ffrt/blob/master/docs/ffrt-api-guideline-cpp.md)).
...
For more information on OpenHarmony ohpm environment configuration, please refer to [How to Install OpenHarmony ohpm Packages](https://gitee.com/openharmony-tpc/docs/blob/master/OpenHarmony_har_usage.md).
...
### 2. Add Header File Include Path in CMakeLists.txt
...
### 3. Add Link Dependency in CMakeLists.txt

```cmake
target_link_libraries(entry PUBLIC libffrt.z.so)
```

### 4. Include Header Files in C++ Code and Call the Corresponding C++ Interfaces
